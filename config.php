...
function next_schedule($id)
{
	...
	while($r=mysql_fetch_array($res))
	{
		...
		if($r[WinnerID]==$r[UserID1]||!$r[WinnerID]) {$score1[$r[UserID1]]++;$score2[$r[UserID2]]++;}
...
Login1=(select concat(if(GuildID>0 and GuildStatusID=1,concat('<img src=/images/gd_guilds/small/',GuildID,'.jpg border=0 align=absmiddle>','</a> '),''),'<a href=/users/',UserID,'/>',Login,'</a>') from ut_users where UserID='$winner') 
where TournamentID='$q[TournamentID]' and Tour='$q[Tour]'+1 and Pair1='$q[Pair]'");

					runsql("update ft_tmp_agreements set UserID2='$winner',
Login2=(select concat(if(GuildID>0 and GuildStatusID=1,concat('<img src=/images/gd_guilds/small/',GuildID,'.jpg border=0 align=absmiddle>','</a> '),''),'<a href=/users/',UserID,'/>',Login,'</a>') from ut_users where UserID='$winner') 
...
Login2=(select concat(if(GuildID>0 and GuildStatusID=1,concat('<img src=/images/gd_guilds/small/',GuildID,'.jpg border=0 align=absmiddle>','</a> '),''),'<a href=/users/',UserID,'/>',Login,'</a>') from ut_users where UserID='$winner') 
 where TournamentID='$q[TournamentID]' and Stage='$q[Stage]'+1 and Pair2='$q[Pair]'");
					...
					runsql("update ft_groups set UserID='$winner',Login=(select concat(if(GuildID>0 and GuildStatusID=1,concat('<a href=/guilds/',GuildID,'><img src=/images/gd_guilds/small/',GuildID,'.jpg border=0 align=absmiddle>','</a> '),''),'<a href=/users/',UserID,'/>',Login,'</a>') from ut_users where UserID='$winner') where TournamentID='$q[TournamentID]' and Stage='$q[Stage]'+1 and Pair='$q[Pair]'");				
...
Login1=(select concat(if(GuildID>0 and GuildStatusID=1,concat('<img src=/images/gd_guilds/small/',GuildID,'.jpg border=0 align=absmiddle>','</a> '),''),'<a href=/users/',UserID,'/>',Login,'</a>') from ut_users where UserID='$place[1]') 
...
Login2=(select concat(if(GuildID>0 and GuildStatusID=1,concat('<img src=/images/gd_guilds/small/',GuildID,'.jpg border=0 align=absmiddle>','</a> '),''),'<a href=/users/',UserID,'/>',Login,'</a>') from ut_users where UserID='$place[2]') 
where TournamentID='$q[TournamentID]' and Tour='$q[Tour]'+1 and ((Pair2='$q[Pair]' and Place2='2') or (Pair1='$q[Pair]' and Place1='2'))");

					}
					elseif($u[StageTypeID]==1)
					{
						runsql("update ft_groups set UserID='$place[1]',Login=(select concat(if(GuildID>0 and GuildStatusID=1,concat('<a href=/guilds/',GuildID,'><img src=/images/gd_guilds/small/',GuildID,'.jpg border=0 align=absmiddle>','</a> '),''),'<a href=/users/',UserID,'/>',Login,'</a>') from ut_users where UserID='$place[1]') where TournamentID='$q[TournamentID]' and Stage='$q[Stage]'+1 and Pair='$q[Pair]' and Place='1'");				
						runsql("update ft_groups set UserID='$place[2]',Login=(select concat(if(GuildID>0 and GuildStatusID=1,concat('<a href=/guilds/',GuildID,'><img src=/images/gd_guilds/small/',GuildID,'.jpg border=0 align=absmiddle>','</a> '),''),'<a href=/users/',UserID,'/>',Login,'</a>') from ut_users where UserID='$place[2]') where TournamentID='$q[TournamentID]' and Stage='$q[Stage]'+1 and Pair='$q[Pair]' and Place='2'");				
