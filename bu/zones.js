...
//макс. число гладиаторов
	if(count == 7 || (document.getElementById("GladLimit").value>0  && count >= document.getElementById("GladLimit").value) ) 
	{
	...
	if(document.getElementById("SklLimit").value>0 && document.getElementById("SklLimit").value<Math.round(skl)+Math.round(pl.Level))
	{	
