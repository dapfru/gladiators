...
function makePlayersAndZones()
{
	...
	for(var i=0; i<playersCount; i++)
	{
		...
		hintHtml += "<tr><td colspan=2><img src=/images/gladiators/"+players[i].TypeID+"_1.png><b>"+players[i].name+" ["+Math.round(players[i].Level)+"] </td></tr>";
...
//		processSliders();
	...
	LoadZones();
			var tacticsHtml="<table border=0 width=300 bgcolor=78746C cellspacing=1 cellpadding=4 style='height:23px'>";
		tacticsHtml+="<TR bgcolor=#545E61 style='height:23px'>";
		tacticsHtml+="<TD>Defence</TD>";
		tacticsHtml+="<TD>"+createSliderHtml('attackTrB','123')+"</TD>";
		tacticsHtml+="<TD>Attack</TD>";
		tacticsHtml+="</TR>";
		
		tacticsHtml+="<TR bgcolor=#3B484C style='height:23px'>";
		tacticsHtml+="<TD>Speed</TD>";
		tacticsHtml+="<TD>"+createSliderHtml('powerTrB','123')+"</TD>";
		tacticsHtml+="<TD>Power</TD>";
		tacticsHtml+="</TR>";
		
		tacticsHtml+="<TR bgcolor=#545E61 style='height:23px'>";
		tacticsHtml+="<TD>Dodge</TD>";
		tacticsHtml+="<TD>"+createSliderHtml('blockTrB','123')+"</TD>";
		tacticsHtml+="<TD>Block</TD>";
		tacticsHtml+="</TR>";
		
		tacticsHtml+="<TR bgcolor=#3B484C style='height:23px'>";
		tacticsHtml+="<TD>Courage</TD>";
		tacticsHtml+="<TD>"+createSliderHtml('courageTrB','123')+"</TD>";
		tacticsHtml+="<TD>Courage</TD>";
		tacticsHtml+="</TR>";
...
function LoadZones()
{
	...
	document.write("<div style='position: absolute' id=rpLabel4  >тест");
	document.write("</div>");
