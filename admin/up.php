...
if(!$q[0]) {print icon("error","” вас нет прав доступа");exit;}


if($act=="delete"&&$step) $form=new cls_form($type,"select");
if($act=="insert"&&$step) $form=new cls_form($type,"select");




print "
¬ы авторизованы как $auth->nick. <a href=\"/register.php?do=logout&act=auth&type=main/authorize\">[выйти]</a> <a href=\"/\">[главна€ страница]</a> <a href=\"/moderate\">[модераци€]</a>";
