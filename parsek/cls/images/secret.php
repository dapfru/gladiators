...
$mas_angle=array(-10,-5,10,20,-15,8);
shuffle($mas_angle);

//$seec - это любое кодовое слово... !! 
$reference=$_SERVER["DOCUMENT_ROOT"]."/misc/fonts/arial.ttf";
...
//Меняем цвет....
$b_color=imagecolorallocate($im, 132, 250, 146);
$t_color = imagecolorallocate($im, 91, 97, 219);
$l_color = imagecolorallocate($im, 72, 209, 18);
