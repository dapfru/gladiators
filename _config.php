...
function addfights($typeid,$k,$i,$numfights,$user1,$user2,$reg,$p1,$p2,$place1,$place2)
{
...
//print "Победитель определен<br>";
		...
		if($q[StageTypeID]==0)
		{
			...
			if(!$u[0]) 
			{
				runsql("insert into ft_winners(TournamentID,UserID,Date,Login) values('$q[TournamentID]','$winner',unix_timestamp(),(select Login from ut_users where UserID='$winner'))");
			...
			else
			{
				...
				if($u[StageTypeID]==0)	
				{
					...
					runsql("update ft_tmp_agreements set UserID1='$winner' where TournamentID='$q[TournamentID]' and Tour='$q[Tour]'+1 and Pair1='$q[Pair]'");
					runsql("update ft_tmp_agreements set UserID2='$winner' where TournamentID='$q[TournamentID]' and Tour='$q[Tour]'+1 and Pair2='$q[Pair]'");
...
(UserID1,UserID2,TypeID,ExtraGlad,LimitGlad,LimitSkl,Timeout,TournamentID,Stage,Tour,Fight,Pair,NumFights,StageTypeID,Approved,StatusID,Date) 
(select UserID1,UserID2,TypeID,ExtraGlad,LimitGlad,LimitSkl,Timeout,TournamentID ,Stage,Tour,Fight,Pair,NumFights,StageTypeID, 1,2,unix_timestamp()
from ft_tmp_agreements where RecordID='$u[RecordID]' and StatusID=0)");
				...
				//обновляем следующий этап------------------------
				runsql("update ft_tmp_agreements set UserID1='$winner' where TournamentID='$q[TournamentID]' and Stage='$q[Stage]'+1 and Pair1='$q[Pair]'");
				runsql("update ft_tmp_agreements set UserID2='$winner' where TournamentID='$q[TournamentID]' and Stage='$q[Stage]'+1 and Pair2='$q[Pair]'");
...
//print "Группа завершена<br>";
				...
				if(!$u[0])
				{
					runsql("insert into ft_winners(TournamentID,UserID,Date,Login) values('$q[TournamentID]','$place[1]',unix_timestamp(),(select Login from ut_users where UserID='$place[1]'))");
					runsql("update ft_tournaments set StatusID=2 where TournamentID='$q[TournamentID]';");
				...
				else
				{
					...
					if($u[StageTypeID]==0)
					{
						runsql("update ft_tmp_agreements set UserID1='$place[1]' where TournamentID='$q[TournamentID]' and Tour='$q[Tour]'+1 and ((Pair1='$q[Pair]' and Place1='1') or (Pair2='$q[Pair]' and Place2='1'))");
						runsql("update ft_tmp_agreements set UserID2='$place[2]' where TournamentID='$q[TournamentID]' and Tour='$q[Tour]'+1 and ((Pair2='$q[Pair]' and Place2='2') or (Pair1='$q[Pair]' and Place1='2'))");
					}
					elseif($u[StageTypeID]==1)
					{
						...
						runsql("update ft_tmp_agreements set UserID1='$place[1]' where TournamentID='$q[TournamentID]' and Stage='$q[Stage]'+1 and ((Pair1='$q[Pair]' and Place1='1') or (Pair2='$q[Pair]' and Place2='1'))");
						runsql("update ft_tmp_agreements set UserID2='$place[2]' where TournamentID='$q[TournamentID]' and Stage='$q[Stage]'+1 and ((Pair2='$q[Pair]' and Place2='2') or (Pair1='$q[Pair]' and Place1='2'))");
					}
