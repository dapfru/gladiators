...
if(!$act) $act="select";
if(!$type) header("Location:http://www.gladiators.ru/xml/moderate/main/support.php");
...
if($act=="delete"&&$step) {$form=new cls_form($type,"select");$act="select";}
if($act=="insert"&&$step) {$form=new cls_form($type,"select");$act="select";}
