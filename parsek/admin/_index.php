...
print "
Вы авторизованы как $auth->nick. <a href=\"/login.php?do=logout&act=auth&type=main/authorize\">[выйти]</a> <a href=\"/\">[ooo-parsek.ru]</a>";
print "<hr><center>";
...
<td><div style=\"margin:2px\"><a href=\"$PHP_SELF?act=delete&step=1&id=$r[MenuID]\" onclick=\"return confirm('".sysmessage(17)."')\"><img src=\"/images/engine/drop.png\" alt=\"".sysmessage(1)."\" title=\"".sysmessage(1)."\" align=absmiddle border=0></a></td>
	...
	if($i==mysql_num_rows($res)) 
	{
		...
		print "$str<img src=\"/images/engine/line3.gif\" width=20 height=20 align=absmiddle> <img src=\"/images/engine/new.gif\" border=0 align=absmiddle> <a href=\"$PHP_SELF?act=insert&type=engine/menu&Parent=$r[Parent]&Rang=".($r[Rang]+1)."&TemplateID=$template\">Добавить</a> ";
	}
...
print "<tr><td valign=middle><img src=\"/images/engine/home.gif\" align=absmiddle width=15 height=18 > Структура сайта</td></tr>";
...
<td><div style=\"margin:2px\"><a href=\"$PHP_SELF?type=engine/tags&act=update&id=$r[TagID]\"><img src=\"/images/engine/edit.png\" align=absmiddle border=0 alt=\"".sysmessage(2)."\" title=\"".sysmessage(2)."\"></a></td>
<td><div style=\"margin:2px\"><a href=\"$PHP_SELF?type=engine/tags&act=delete&step=1&id=$r[TagID]\" onclick=\"return confirm('".sysmessage(17)."')\"><img src=\"/images/engine/drop.png\" alt=\"".sysmessage(1)."\" title=\"".sysmessage(1)."\" align=absmiddle border=0></a></td>
</tr>";
elseif($step==2) print "
<td><a href=\"$PHP_SELF?type=engine/pages&act=translate&id=$r[PageID]\"><img src=\"/images/engine/report.gif\" align=absmiddle border=0></a></td>
<td><div style=\"margin:2px\"><a href=\"$PHP_SELF?type=engine/pages&act=update&id=$r[PageID]\"><img src=\"/images/engine/edit.png\" align=absmiddle border=0 alt=\"".sysmessage(2)."\" title=\"".sysmessage(2)."\"></a></td>
...
<td></td>
	...
	if($i==mysql_num_rows($res)) 
	{
		...
		if($step==3) print "$str<img src=\"/images/engine/line3.gif\" width=20 height=20 align=absmiddle> <img src=\"/images/engine/new.gif\" border=0 align=absmiddle> <a href=\"$PHP_SELF?type=engine/tags&act=insert&PageID=$page\">Добавить</a> ";
		elseif($step>1) print "$str<img src=\"/images/engine/line3.gif\" width=20 height=20 align=absmiddle> <img src=\"/images/engine/new.gif\" border=0 align=absmiddle> <a href=\"$PHP_SELF?type=engine/pages&act=insert&Site=$site\">Добавить</a> ";
	}
	...
	if(!mysql_num_rows($res)&&$step==3) 
	{
		...
		print "$str<img src=\"/images/engine/line3.gif\" width=20 height=20 align=absmiddle> <img src=\"/images/engine/new.gif\" border=0 align=absmiddle> <a href=\"$PHP_SELF?type=engine/tags&act=insert&PageID=$page\">Добавить</a> ";
...
print "<tr><td valign=middle><img src=\"/images/engine/tree.gif\" align=absmiddle  > Структура файлов</td></tr>";
