...
function hidehint($userID,$pageID,$type)
{
	$objResponse =  new xajaxResponse();
	...
	if($userID&&$pageID)
	{
		...
		if($type==1) mysql_query("insert ignore into ut_hint_status values($pageID,$userID)");
...
<center>Готовится бета-тестирование игры<br><br>
	  </td>
          <td>&nbsp;</td>
        </tr>
      </table></td>
...
$curmenu='';
	...
	while($r=mysql_fetch_array($res))
	{
		...
		else $a= "<a href=\"javascript:;\"$target onclick='setcurmenu($r[MenuID],\"$r[Url]\");'><div id='upmenu$r[MenuID]' $class>".$r[name]."</div></a>";
...
function setcurmenu(menuid,url)
{
document.location.replace('http://www.butsa.ru');

	if(menuid==curmenu) document.location.replace(url);
...
?>
  ...
  <tr> 
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>&nbsp;</td>
          <td width="768"><img src="<?=$site_url?>images/index-top-main.gif" alt="" width="768" height="17" border="0"></td>
          <td>&nbsp;</td>
        </tr>
      </table></td>
  </tr>
...
<input type="hidden" name="url" value="<?=$url?>"/>
                  ...
                  <td width="8">&nbsp;</td>
                  <td width="108">
<input type="text" name="auth_name"  style="width: 108px;background:16191C;color:E5CEA6;border:1px solid #53585B;height:20px;background-image:url('/images/formbg.gif');"></td>
                  <td width="38">&nbsp;</td>
                  <td width="39">Пароль:</td>
                  <td width="8">&nbsp;</td>
                  <td width="108" >
<input type="password" name="auth_pass"  style="width: 108px;background:16191C;color:E5CEA6;border:1px solid #53585B;height:20px;background-image:url('/images/formbg.gif');"></td>
                  <td width="17">&nbsp;</td>
                  <td width="49">
<input type="submit" style="background:16191C;color:E5CEA6;border:1px solid #53585B;height:20px;background-image:url('/images/formbg.gif');" value="Войти">
...
<img src="<?=$site_url?>images/btn-led1.gif" width="21" height="37" border="0"/>
  ...
  <tr> 
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>&nbsp;</td>
          <td width="768" bgcolor="#343d40"><img src="<?=$site_url?>images/index-top-main.gif" alt="" width="768" height="17" border="0"></td>
          <td>&nbsp;</td>
        </tr>
      </table></td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>&nbsp;</td>
          <td width="768"  height="606" valign="top" class="table-main">
